...
public class ViewerActivityController extends AbstractActivityController<ViewerActivity> implements
     ...
     * {@inheritDoc}
     *
     * @see IActivityController#runOnUiThread(Runnable)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see IActivityController#jumpToPage(int, float, float)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see IActivityController#getDecodeService()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see IActivityController#getDecodingProgressModel()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see IActivityController#getDocumentModel()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see IActivityController#getSearchModel()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see IActivityController#getDocumentController()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see IActivityController#getView()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see IActivityController#getBookSettings()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see IActivityController#getActionController()
     */
    @Override
