...
public class RecentActivityController extends AbstractActivityController<RecentActivity> implements IBrowserActivity,
     ...
     * {@inheritDoc}
     *
     * @see IBrowserActivity#setCurrentDir(java.io.File)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see IBrowserActivity#showDocument(android.net.Uri,
     ...
     * {@inheritDoc}
     *
     * @see IBrowserActivity#loadThumbnail(String, android.widget.ImageView, int)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.emdev.common.filesystem.MediaManager.Listener#onMediaStateChanged(String,
