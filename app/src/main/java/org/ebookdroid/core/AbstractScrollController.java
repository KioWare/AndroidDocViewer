...
public abstract class AbstractScrollController extends AbstractViewController {
     ...
     * {@inheritDoc}
     *
     * @see AbstractViewController#onLayoutChanged(boolean, boolean, android.graphics.Rect,
     ...
     * {@inheritDoc}
     *
     * @see org.ebookdroid.ui.viewer.IViewController#isPageVisible(Page,
     *      ViewState, android.graphics.RectF)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.ebookdroid.ui.viewer.IViewController#pageUpdated(ViewState,
     *      Page)
     */
    @Override
