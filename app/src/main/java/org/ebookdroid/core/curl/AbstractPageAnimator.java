...
public abstract class AbstractPageAnimator extends SinglePageView implements PageAnimator {
     ...
     * {@inheritDoc}
     *
     * @see SinglePageView#isPageVisible(org.ebookdroid.core.Page,
     ...
     * {@inheritDoc}
     *
     * @see SinglePageView#flipAnimationStep()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see SinglePageView#draw(org.ebookdroid.core.EventGLDraw)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see SinglePageView#onTouchEvent(android.view.MotionEvent)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see SinglePageView#animate(int)
     */
    @Override
