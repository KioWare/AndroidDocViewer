...
public class DecodeServiceStub implements DecodeService {
     ...
     * {@inheritDoc}
     *
     * @see DecodeService#open(String, String)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see DecodeService#decodePage(ViewState,
     *      PageTreeNode)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see DecodeService#stopDecoding(PageTreeNode, String)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see DecodeService#getPageCount()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see DecodeService#getUnifiedPageInfo()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see DecodeService#getPageInfo(int)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see DecodeService#updateViewState(ViewState)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see DecodeService#createThumbnail(booleam int, int, int, android.graphics.RectF)
     */
    @Override
