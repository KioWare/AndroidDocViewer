...
public final class AdminPreferencev14 extends org.emdev.ui.preference.SwitchPreferenceEx implements OnPreferenceChangeListener {

    private DevicePolicyManager mDPM;
    private ComponentName mDeviceAdminRcvr;
    private Activity mActivity;
    
    public AdminPreferencev14(final Context context, final AttributeSet attrs) {
        super(context, attrs);
